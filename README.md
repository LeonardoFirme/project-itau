...
Aqui está o **README.md** estruturado com o profissionalismo exato que você exige, detalhando cada arquivo e a arquitetura moderna (Next.js 16+, Tailwind v4 e `proxy.ts`) aplicada ao **Project-itau**.
